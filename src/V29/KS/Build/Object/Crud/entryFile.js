...
const CommonRegisterCommand = "KS.Build.Object.Crud";

const { StartFunc: StartFuncFromForV2 } = require("./ForV2/entryFile");
...
const LocalFuncToActivate = async () => {
    ...
    const LocalColumnsAsArray = [];
    const LocalData = {};

    await StartFuncFromForV2({
